#!/usr/bin/env python3
"""b55：生成b55 五条小红书图文实录 HTML。

用法：
  python3 scripts/b55-html.py {slug} [{slug} ...]
  python3 scripts/b55-html.py          # 合并 part1+part2+… 全部
"""
...
def main() -> None:
    data = load_data()
    if not data:
        raise SystemExit("未找到 b55_data.py")
    args = sys.argv[1:]
