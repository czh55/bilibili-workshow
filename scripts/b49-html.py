#!/usr/bin/env python3
"""b49：生成 24 篇小红书图文实录 HTML（含转录注入、简体转换、图注双语）。

用法：
  python3 scripts/b48-html.py {slug} [{slug} ...]
  python3 scripts/b48-html.py          # 全部
"""
...
SLUG_TO_AUDIO = {
    "fast-serve-return": "c01",
    "tulip-latte-fix": "c02",
    "latte-froth-lesson2": "c03",
    "espresso-extraction-latte": "c04",
    "extraction-latte-impact": "c05",
    "asymmetric-beauty": "c06",
    "bone-face-over-skin": "c07",
    "skirt-shoes-socks-outfit": "c08",
    "latte-champion-interview": "c09",
    "ultra-clear-video": "c10",
    "forehead-beauty-standards": "c11",
    "flaws-to-classic": "c12",
    "luxury-brand-preference": "c13",
    "high-cheekbone-forehead": "c14",
    "jianying-architecture": "c15",
    "ai-digital-human": "c16",
    "jianying-editing-guide": "c17",
    "jianying-hidden-features": "c18",
    "davinci-coloring": "c19",
    "davinci-node-system": "c20",
    "color-wheel-three": "c21",
    "color-grade-principles": "c22",
    "secondary-grading": "c23",
    "yuqi-fashion-guide": "c24",
}
