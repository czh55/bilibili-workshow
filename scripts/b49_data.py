...
DATA = {
 ...
 "color-grade-principles": {
  ...
  "takeaway": "调色底层原理=光的构成→色彩关系→色彩要素→流程。①光的构成：RGB三盏灯重叠出黄/品红/青，调节亮度成12色相环，达芬奇色轮排版对应。②三大色彩关系：互补色=180度相对（黄蓝/红青/绿品红）最强对比创造视觉焦点+突出主体（橙青色调）+校正肤色（偏黄加蓝）；邻近色=60度（红黄/蓝青/紫品红）和谐统一，暖调温馨冷调冷静；单色系=同色变明度饱和，简约高级，杂乱场景化繁为景。③色彩三要素：明度=色彩骨架（示波器0%-100%），塑造立体+引导视线，色轮整体+曲线局部；饱和度=鲜艳程度，0%灰-100%鲜艳，高饱和活力低饱和凝重，0=黑白；色相=基本相貌对应曲线位置，移动改风格，统一或对比突出焦点，扭曲器色相饱和联动。④流程：先整体后局部=一级垫底+二级局部；Log灰片五步=明暗反差→影调（避免过曝死黑）→色相饱和统一→风格化（曲线压实+暗角）→局部强化。⑤实战：直出理想跳过基础校正，影调→色相修正天空花草→饱和度→肤色磨皮校正→天空青绿→暗部偏蓝→电影暗角。",
  "chapters": [
   {
    "id": "ch1",
    "time": "00:00-00:51",
...
"yuqi-fashion-guide": {
  ...
  "takeaway": "雨琦变时尚的核心思路=眉眼重心法。①面部特征：短心形脸+眉间距远（眉头眼头同一位置）。②两大问题：娇俏眉眼碰上偏粗偏中性鼻子→风格没平衡好鼻子抢戏；肉肉饱满脸容易垂显疲惫。③变美关键一=面部状态更紧致（解决垂和松）；关键二（易忽略细节）=鼻梁有存在感→有意识加重鼻影→中性鼻子跟甜甜眉眼平衡；关键三=眼妆更有存在感，把视觉重点往眉眼上带。④眉间距偏宽的误区：别用刘海遮眉毛——鼻梁有存在感+厚重大面积刘海遮额头→视觉反而更集中到鼻子→适得其反。⑤聪明方法：把重心放在眉眼上，通过更有存在感的眼妆把视觉重心往上移，五官比例反而更和谐协调。",
  "chapters": [
   {
    "id": "ch1",
    "time": "00:00-00:40",
