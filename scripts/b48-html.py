#!/usr/bin/env python3
"""b48：生成 11 篇小红书图文实录 HTML（含转录注入、简体转换、图注双语）。
...
SLUG_TO_AUDIO = {
    "light-ratio-texture": "v01",
    "street-style-fashion": "v02",
    "stairs-atmosphere-shot": "v03",
    "purple-gray-advanced": "v04",
    "daily-expression-possession": "v05",
    "jewelry-black-photo": "v06",
    "new-rule-content-power": "v07",
    "worst-talent-2026": "v08",
    "stir-fry-water-mistake": "v10",
    "knowledge-base-depreciation": "v11",
    "valentine-rose-tutorial": "v12",
}
