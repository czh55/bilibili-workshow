#!/usr/bin/env python3
"""b46：生成 14 篇小红书图文实录 HTML（含转录注入、简体转换）。

用法：
  python3 scripts/b46-html.py {slug} [{slug} ...]
  python3 scripts/b46-html.py          # 全部 14 篇
"""
...
SLUG_TO_AUDIO = {
    "latte-3-moves": "f01",
    "latte-correction-share": "f02",
    "round-face-makeup": "f03",
    "ai-talking-edit": "f04",
    "documentary-color-tone": "f05",
    "latte-big-heart": "f06",
    "round-face-adjust": "f07",
    "rgb-curve-basics": "f08",
    "skirt-photo-poses": "f09",
    "ai-love-shortfilm": "f10",
    "couple-quarrel": "f11",
    "promotion-interview": "f12",
    "inner-drain-reason": "f13",
    "new-leader-team": "f14",
}
