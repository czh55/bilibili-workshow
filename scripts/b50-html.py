#!/usr/bin/env python3
"""b50：生成 14 篇小红书图文实录 HTML（含转录注入、简体转换、图注双语）。

用法：
  python3 scripts/b50-html.py {slug} [{slug} ...]
  python3 scripts/b50-html.py          # 全部
"""
...
SLUG_TO_AUDIO = {
    "la-la-land-colorist": "d01",
    "lut-placement-tips": "d02",
    "alibaba-465b-share-sale": "d03",
    "finalcut-auto-edit-workflow": "d04",
    "tree-vs-wall-crash": "d05",
    "latte-art-integration": "d06",
    "top-beauty-nose-design": "d07",
    "liquify-beats-colorgrade": "d08",
    "bright-skin-one-minute": "d09",
    "liquify-bone-structure": "d10",
    "chin-aesthetics-code": "d11",
    "forehead-aesthetics-design": "d12",
    "facial-balance-features": "d13",
    "latte-no-crema": "d14",
}
