#!/usr/bin/env python3
"""b53：生成佳期KK职场双视频图文实录 HTML。

用法：
  python3 scripts/b53-html.py {slug} [{slug} ...]
  python3 scripts/b53-html.py          # 合并 part1+part2+… 全部
"""
...
def main() -> None:
    data = load_data()
    if not data:
        raise SystemExit("未找到 b53_data.py")
    args = sys.argv[1:]
